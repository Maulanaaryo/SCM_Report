...
-- 1
Select  BookingProcessId, Cast('' as varchar(120)) as [Internal-External], Cast('' as varchar(120)) as SalesPIC, Cast('' as varchar(120)) as MBL, Cast('' as DateTime) as ExeDate,Cast('' as DateTime) as ATD, Cast('' as DateTime) as ATA,Cast('' as varchar(120)) as ProcessNumber,Cast('' as varchar(120)) as BookingNo, Cast('' as varchar(120)) as Carrier,Cast('' as varchar(120)) as POL, Cast('' as varchar(120)) as POD,Cast('' as varchar(120)) as Customer,Cast(0 as int) as [20],Cast(0 as int) as [40],Cast(0 as int) as [Other],
...
ProcessNumber = #BookingDetails.JobNo, BookingNo = #BookingDetails.BookingNo, #CarrierDetails.ATD = #BookingDetails.ATD, #CarrierDetails.ATA = #BookingDetails.ATA
...
;WITH ConsolidatedCarrierDetails AS (
  ...
  GROUP BY cd.BookingNo, cd.ATD, cd.ATA
)
-- 5
SELECT 
  *
